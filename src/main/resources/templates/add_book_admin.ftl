...
<div class="container">
  ...
  <div>
    <form role="form" action="/view/add_book_submit.do">
      <div class="form-group">
        <label for="bookname">书名</label>
        <input type="text" class="form-control" id="bookname" placeholder="请输入书名" name="bookname" required>
      </div>
      <div class="form-group">
        <label for="author">作者</label>
        <input type="text" class="form-control" id="author" placeholder="请输入作者" name="author" required>
      </div>
