...
<div class="container">
    ...
    <div class="row clearfix" id="pan">
        <nav class="navbar navbar-default container" role="navigation">
            <form class="navbar-form" role="search" action="book_center_admin.html">
        ...
        <div class="panel panel-info">
            ...
            <table class="table table-hover">
                </tr><th>书号</th><th>书名</th><th>作者</th><th>状态</th><th>操作</th></tr>
                <#list list as item>
                    <tr><td>${item.id}</td><td>${item.bookName}</td><td>${item.author}</td><td>${item.isBorrowed()?string("已借出", "未借出")}</td>
                        <td>
                            <a href="/view/delete_book_submit.do?bookId=${item.id}">删除</a>
                            <a href="/view/change_book_info.html?bookId=${item.id}">修改</a>
                        </td>
                    </tr>
                </#list>
            </table>
        ...
        <div style="float:right">
          <button type="button" class="btn btn-default">
            <a href="/view/add_book_admin.html">添加</a>
          </button>
        </div>
    </div>
</div>
