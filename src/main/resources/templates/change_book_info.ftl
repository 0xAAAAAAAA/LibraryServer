...
<head>
  ...
  <title>Tiny图书馆管理系统-修改书籍信息</title>
...
<div class="container">
  ...
  <div>
    <form role="form" action="/view/change_book_submit.do">
      <div class="form-group">
        <input type="hidden" id="bookId" name="bookId" value="${book.id}" required>
      </div>
      <div class="form-group">
        <label for="bookname">书名</label>
        <input type="text" class="form-control" id="bookname" placeholder="${book.bookName}" name="bookname" required>
      </div>
      <div class="form-group">
